  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (email && password) {
        toast({
          title: 'ログイン成功',
          description: '広告主ダッシュボードにリダイレクトします。'
        })
      ...
      <div className="w-full max-w-md space-y-6">
          ...
          <div className="flex items-center justify-center space-x-3">
            ...
            <div>
              ...
              <Badge className="bg-blue-100 text-blue-800 flex items-center space-x-1 w-fit">
                ...
                <span className="text-xs">広告主ログイン</span>
              </Badge>
            </div>
          </div>
        </div>
        ...
        <Card className="border-blue-200">
          <CardHeader className="space-y-1">
            <CardTitle className="text-2xl text-center">広告主ログイン</CardTitle>
            <CardDescription className="text-center">
              広告主としてログインして案件を管理してください
            </CardDescription>
          </CardHeader>
          <CardContent>
            ...
            <div className="mt-6 p-4 bg-gray-50 border border-gray-200 rounded-lg">
              ...
              <div className="space-y-2">
                <button
                  ...
                  onClick={() => {
                    setEmail('advertiser@tyokudori.com')
                    setPassword('advertiser123')
                  }}
                >
                  <div className="font-mono">
                    <div><span className="text-gray-500">ID:</span> advertiser@tyokudori.com</div>
                    <div><span className="text-gray-500">PW:</span> advertiser123</div>
                  </div>
                </button>
              </div>
            </div>
          ...
          <CardContent className="pt-6">
            <div className="flex items-start space-x-3">
              ...
              <div className="text-sm text-blue-800">
                <p className="font-semibold mb-1">広告主でできること</p>
                <ul className="text-xs space-y-1">
                  <li>• 新規案件の作成・管理</li>
                  <li>• アフィリエイターからの申請管理</li>
                  <li>• 成果の承認・拒否</li>
                  <li>• 詳細なレポート・分析</li>
                </ul>
              </div>
